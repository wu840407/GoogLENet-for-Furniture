...
class FurnitureOCR(object):
    ...
    def saveModel(self):
        ...
        torch.save(self.net.state_dict(), './v2weight.t7')
        ...
        torch.save(state, './v2weight.t7')

        # save entire model
        torch.save(self.net, './v2model.pt')
        return
...
if __name__ == '__main__':
    ...
    ocr = FurnitureOCR('./Furniture', 240, 32, 0.001)